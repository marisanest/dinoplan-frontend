    ...
    return (
        <div className="w-full">
            <div className="grid grid-cols-[1fr_30px] cursor-pointer my-[0.75rem] sm:my-[1rem]"
                ...
                <div
                    className="min-w-[27px] w-[27px] min-h-[27px] h-[27px] xs:min-w-[30px] xs:w-[30px] xs:min-h-[30px] xs:h-[30px] flex justify-center items-center rounded-full bg-red-200">
                    <ArrowIcon
