...
export default function ServiceSegmentsContainer({children}: ReactNodeProps) {
    ...
    return (
        <div className="relative z-10 w-full flex justify-center px-x-sm sm:px-0">
            <div className={cn(
                "w-full sm:w-sm sm:max-w-sm px-x-s s:px-x-sm py-y-sm bg-orange-200 rounded-tr-md shadow-[0px_0px_0px_0px_black] transition-[border-radius] duration-1000",
