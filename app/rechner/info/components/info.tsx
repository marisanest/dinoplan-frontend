...
export default function CalculatorInfo({customer}: {customer: any}) {
    return (
        <main className="w-full min-h-[calc(100dvh-var(--height-banner)-var(--height-footer-image)+var(--spacing-footer-image-correction))] flex flex-col items-center px-x-s xs:px-x-sm sm:px-0 pt-[calc(var(--height-banner)+var(--spacing-y-sm))] bg-orange-300">
